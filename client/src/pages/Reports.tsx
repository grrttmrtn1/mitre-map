...
export default function Reports() {
  ...
  const exportLinks = [
    { label: 'ATT&CK Navigator Layer', type: 'navigator' as const },
    { label: 'Detections CSV', type: 'detections/csv' as const },
    { label: 'Tools CSV', type: 'tools/csv' as const },
    { label: 'Coverage JSON', type: 'coverage/json' as const },
  ];
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-shrink-0 px-6 py-4 border-b border-slate-800 bg-slate-900/50">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-0.5">Generated {new Date(report.generated_at).toLocaleString()}</p>
          </div>
          <div className="flex gap-2">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 top-full mt-1 w-52 bg-slate-800 border border-slate-700 rounded-lg shadow-xl z-50 hidden group-hover:block">
                {exportLinks.map(l => (
                  <a key={l.type} href={api.getExportUrl(l.type)} download
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        {activeTab === 'threats' && threatReport && (
